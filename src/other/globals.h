...
public:
    ...
    static const unsigned long version;
    static const unsigned long version_min;
    static const bool          version_stable;
    ...
    const std::string
        ...
        user_allow_builder_queuing,
        user_avoid_builder_queuing,
        user_avoid_batter_to_exploder,
        user_prioinv_middle,
        user_prioinv_right,
        ...
        user_arrows_replay,
        user_arrows_network,
        user_game_show_tooltips,
        user_game_show_skill_keys,
        user_debris_amount,
        user_debris_type,
        user_gui_color_red,
        ...
        user_key_rate_plus,
        user_key_pause,
        user_key_speed_back_one,
        user_key_speed_back_many,
        user_key_speed_ahead_one,
        user_key_speed_ahead_many,
        user_key_speed_fast,
