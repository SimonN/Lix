...
const unsigned long Globals::version       (CONCAT(2015, 08, 09, 00));
...
:
    ...
    user_allow_builder_queuing   ("MULTIPLE_BUILDERS"),
    user_avoid_builder_queuing   ("AVOID_BUILDER_QUEUING"),
    user_avoid_batter_to_exploder("BATTER_PRIORITY"),
    ...
    user_game_show_tooltips      ("GAME_SHOW_TOOLTIPS"),
    user_game_show_skill_keys    ("GAME_SHOW_SKILL_KEYS"),
    ...
    user_key_speed_back_one      ("KEY_SPEED_BACK_ONE"),
    user_key_speed_back_many     ("KEY_SPEED_BACK_MANY"),
    user_key_speed_ahead_one     ("KEY_SPEED_SLOW"),
    user_key_speed_ahead_many    ("KEY_SPEED_AHEAD_MANY"),
    ...
    file_translations_dump       (dir_data.get_dir_rootless() + "translate_dump.txt"),
    ...
    file_bitmap_implosion        (dir_data_bitmap.get_dir_rootless() + "implode.I"),
...
void Globals::initialize()
{
    ...
    if (file_exists(testdir.c_str(), FA_DIREC | FA_RDONLY, 0)) rootdir = "./";
        ...
        testdir = '.' + testdir;
        if (file_exists(testdir.c_str(), FA_DIREC | FA_RDONLY, 0)) {
            rootdir = "../";
        }
    }
