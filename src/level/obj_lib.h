...
public:
    ...
    static const Object* get             (const Filename&);
...
private:
    ...
    std::map    <std::string, Filename> queue;
    ...
    std::vector <Object*>               vgaspec;
           ...
           void load_file         (const std::string&, const Filename&);
    static void load_file_callback(const Filename&, void*);
    static void decrunch_level    (const Filename&, void*);
