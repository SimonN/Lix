...
Currently, all level files will use bitmap files from <lix>/bitmap/Matt. Matt has told me that the directory structure of the bitmaps is subject to change, so I'll use the current structure on this repository for now.
